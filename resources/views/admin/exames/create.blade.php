  ...
  <div class="" >
       <div class="striped ">
          <div class="modal-content">
              ...
              <h4><i class="material-icons"></i> Cadastrar Novo exameg</h4>

              <form class="col s12" action="{{route('admin.exames.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="file-field input-field col s12">
                        ...
                        <div class="input-field col s12">
                          ...
                          <div class="input-field col s6">
                            ...
                            <label for="data_de_lancamento"></label>
                          </div>
                    ...
                    <a href="{{route('admin.exames.add')}}" class=" waves-effect waves-green btn red right">Cancelar</a><br>
