  ...
  <div class="" >
       <div class="striped ">
          <div class="modal-content">
              ...
              <h4><i class="material-icons"></i> Cadastrar Nova satividade</h4>

              <form class="col s12" action="{{route('admin.satividade.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="{{route('admin.satividades.add')}}" class=" waves-effect waves-green btn red right">Cancelar</a><br>
